    ...
    static func prepareExample() -> [TicketDetailsViewState.TicketDetailsCellDisplayData] {
        [
            .init(
                ...
                value: """
                Нет доступа к почтовому ящику. у одного из сотрудников перестал работать почтовый ящик
                по старому паролю. Пользователь skaviani (Садех Кавиани).
                В свой личный кабинет войти он тоже не может, пароль не подходит, а сменить не может,
                так как кабинет привязан к почте КФУ, к которой также не работает пароль.
            ...
            .init(
                ...
                value: """
                Отдел технического сопровождения пользователей (рук. Мулюков Рустем Ирекович).
                Исполнители: Ханнанов Карим Ринатович.
                """
            ),
            .init(
                order: 2,
                ...
                value: """
                Работы по заявке произведены, Проверка почтового ящика. Доступ к эл.почте предоставлен.
                (Ханнанов Карим Ринатович, 10.11.2023 16:23) (сделано полностью)
                """
            ),
            .init(
                order: 3,
            ...
            .init(
                ...
                value: """
                "Адрес:    Учебное здание №12 (Физический факультет)\n(Казань, ул. Кремлевская, д. 16а)
